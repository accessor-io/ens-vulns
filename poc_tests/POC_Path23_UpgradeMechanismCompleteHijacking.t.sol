...
contract POC_Path23_UpgradeMechanismCompleteHijacking is Test {
    ENS public ens;
    ...
    function test_Path23_UpgradeMechanismCompleteHijacking() public {
        ...
        console.log("Path 23 PoC: Complete hijacking of upgrade mechanism");
    }
}